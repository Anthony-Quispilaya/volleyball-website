    ...
    return (
        <div className="actions">
            <div className="flex justify-end items-center gap-2">
                ...
                {/*Video Call Action*/}
                <button className="p-2 rounded-full hover:bg-btn-hover">
                    <svg className="w-6" viewBox="0 -4 24 24" id="meteor-icon-kit__solid-video" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fillRule="evenodd" clipRule="evenodd" d="M18 3.61257L22.6838 2.05132C23.3313 1.83547 24 2.31744 24 3V13C24 13.6826 23.3313 14.1645 22.6838 13.9487L18 12.3874V13C18 14.6569 16.6569 16 15 16H3C1.34315 16 0 14.6569 0 13V3C0 1.34315 1.34315 0 3 0H15C16.6569 0 18 1.34315 18 3V3.61257z" fill="#2C428C"></path></g></svg>
                </button>
                {/*More Actions*/}
                <button className="p-2 rounded-full hover:bg-btn-hover">
                    <svg className="w-6" viewBox="0 -7 20 20" id="meteor-icon-kit__solid-ellipsis-h" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fillRule="evenodd" clipRule="evenodd" d="M2.5 5.5C1.11929 5.5 0 4.3807 0 3C0 1.6193 1.11929 0.5 2.5 0.5C3.88071 0.5 5 1.6193 5 3C5 4.3807 3.88071 5.5 2.5 5.5zM17.5 5.5C16.1193 5.5 15 4.3807 15 3C15 1.6193 16.1193 0.5 17.5 0.5C18.8807 0.5 20 1.6193 20 3C20 4.3807 18.8807 5.5 17.5 5.5zM10 5.5C8.6193 5.5 7.5 4.3807 7.5 3C7.5 1.6193 8.6193 0.5 10 0.5C11.3807 0.5 12.5 1.6193 12.5 3C12.5 4.3807 11.3807 5.5 10 5.5z" fill="#2C428C"></path></g></svg>
                </button>
            </div>  
        </div>
    )
